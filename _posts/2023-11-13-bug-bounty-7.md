...
Exploitation of this vulnerability is very simple, especially being an Azure VM. Although you have all the information in the GoDiego post I mentioned before, I will detail the process step by step:
...
7. Finally, you can run the dig command again on the vulnerable subdomain
   ...
   and you will see how the subdomain already appears as taken and pointing to the IP of your virtual machine (region covered in green). If you now access the vulnerable subdomain you will see that the HTML code you have previously left in your Azure virtual machine appears
...
As you can see, this is not a vulnerability due to technical implementation failures or something like that, it seems more like a vulnerability related to the management of the company's assets. Some of the reasons that could lead to the presence of this vulnerability in the assets of a company are:
