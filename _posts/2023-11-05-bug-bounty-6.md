...
The discovery of the vulnerability was fairly straightforward. I tried to login with the user *bugbounty*, just to test the form, and I got the following response

![](/assets/images/2023-11-05-bug-bounty-6/reflected-username.png)

This is suspicious because it is usual to find messages of the type *Incorrect credentials*, where the reason for the failure is not detailed and the user's name is not reflected. Taking into account that the user's name is reflected, I sent the following payload as username
...
We can assume that the vulnerable request is as follows
...
In this case this technique worked but I can say that I found other POST XSS in which this technique did not work. Unfortunately I don't keep screenshots of the errors obtained in those situations because at that time I didn't ask myself too many questions about the causes of my errors.
...
<p style="text-align:center;"><img src="/assets/images/2023-11-05-bug-bounty-6/relax-bro.jpg"></p>
